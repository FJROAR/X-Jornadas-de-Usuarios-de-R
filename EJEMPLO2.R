...
# Return NA instead of tolower error. Esta función evita el "pete" del tolower en la librería
#tm. Más adelante se analiza otra función más potente en otras librerías que no requiere este
#wrapper
...
#Eliminación de stopwords e introducción de algunas adicionales
...
#Inspección de algunos elementos
corpus[[3]][[1]]
corpus[[3]][[2]]
